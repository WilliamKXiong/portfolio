...
export default function Home(): JSX.Element {
    return (
        <Container fluid>
            ...
            <Row>
                <ProjectCard
                    mediaFile={MediaFile.JavaBattleship}
                    cardTitle="Java Battleship(2018)"
                    cardText={
                        "The popular Battleship game made in Java, using Java Swing for the GUI. Ability to save/load game, GUI detects monitor size, fullscreen,"
                        + "uses threads for user/AI turn and win/loss detection. An ambitious project over the course of a college summer semester."
                    }
                    buttonLink="https://github.com/IsGai/Java-Battleship-Game"
                />
                <ProjectCard
                    mediaFile={MediaFile.PcBuilder}
                ...
                />
                <ProjectCard
                    mediaFile={MediaFile.MyPortfolio}
            ...
            <Row className="pb-5">
                <ProjectCard
                    mediaFile={MediaFile.PublicTransportVehicleEstimator}
                    ...
                    cardText={
                        ...
                        + "Dijkstra's algorithm is used to find the best routes, admin results are found through simulation, and GUI work is done in Java Swing API."
                    }
